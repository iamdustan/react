 ...
 *
 * @providesModule ReactShallowStackRenderer
 * @preventMunge
 */
...
class ReactShallowStackRendererRenderer {
  _instance = null;
  getMountedInstance() {
  ...
  render(element, context) {
    ...
    invariant(
      ...
      'ReactShallowStackRenderer render(): Invalid component element.%s',
    ...
    invariant(
      ...
      'ReactShallowStackRenderer render(): Shallow rendering works only with custom ' +
...
module.exports = ReactShallowStackRenderer;
